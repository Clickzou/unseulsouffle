 ...
 *
 * RÈGLE : aucun élément de parcours n'est inventé. Les bios du site legacy sont
 * conservées telles quelles, le reste décrit la façon d'intervenir et les
 * situations traitées — ce qui est vérifiable. Les données biographiques
 * manquantes sont marquées `aFournir`, jamais comblées.
 */
...
export const membres: PageMembre[] = [
  {
    ...
    essentiel:
      "Marjorie Anglade est associée fondatrice du cabinet Un Seul Souffle et référente du pilier finance et pilotage. Elle intervient à temps partagé auprès de PME et d'ETI de 10 à 250 salariés en Occitanie, sur le prévisionnel de trésorerie, les tableaux de bord de gestion et l'analyse de marge. Elle ne se substitue pas à l'expert-comptable de l'entreprise : elle travaille à partir des comptes produits, en amont des décisions du dirigeant.",
    ...
    faq: [
      {
        ...
        r: [
          "Le cabinet n'exerce pas la profession d'expert-comptable, qui est un titre réglementé et suppose une inscription à l'Ordre. Un Seul Souffle ne produit ni comptes annuels ni déclarations fiscales.",
          "L'intervention porte sur le pilotage : prévisionnel, tableaux de bord, marges, préparation des décisions. Elle se fait à partir des comptes établis par l'expert-comptable de l'entreprise, en complément de son travail.",
        ],
        aFournir: true,
      },
      {
